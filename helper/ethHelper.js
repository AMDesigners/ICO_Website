...
const coinAddress = "0x79Cb5a03a375A073e248d0cf27dFdF6DaA227d39";
...
const AdminCoinTransfer = async (receiver_address, amount) => {
  ...
  let sendAmount = BigInt(amount * Math.pow(10, 18)).toString();
  ...
  let rawTransaction = {
    ...
    data: tokenContract.methods
      .transfer(receiver_address, sendAmount)
      .encodeABI(),
  ...
  let hash = web3js.eth.sendSignedTransaction(
