...
!(function (t) {
  ...
  function a(e, a) {
    ...
    if (p !== !0) var p = !1;
    s.each(function () {
      "undefined" != typeof t(this).attr("selected") &&
        t(this).attr("selected") !== !1 &&
        (o = t(this).text()),
        (c +=
      ...
      "undefined" != typeof n && n !== !1
        ? (id_html = n)
        : ((id_html = "awselect_" + awselect_count), t(e).attr("id", id_html));
    var _ =
      '<div data-immersive="' +
      p +
      '" id="awselect_' +
      ...
      f +
      '" class = "bg"></div>';
    (_ += '<div style="padding:' + m + " " + w + '" class = "front_face">'),
      (_ += '<div style="background:' + d + '" class = "bg"></div>'),
      (_ +=
        ...
        u +
        '" class = "content">'),
      o !== !1 && (_ += '<span class="current_value">' + o + "</span>"),
      (_ += '<span class = "placeholder">' + i + "</span>"),
      (_ += '<i class = "icon">' + r(u) + "</i>"),
      (_ += "</div>"),
      (_ += "</div>"),
      (_ +=
        '<div style="padding:' +
  ...
  function i(e) {
    if (0 == e.hasClass("animating")) {
      ...
      (t(window).width() < mobile_width || "true" == i) && (n(e), (a += 200)),
        setTimeout(function () {
          var a = e.find(".back_face");
          a.show();
          var n = e.find("> .bg");
          n.css({ height: e.outerHeight() + a.outerHeight() }),
            a.css({ "margin-top": t(e).outerHeight() }),
            (t(window).width() < mobile_width || "true" === i) &&
              e.css({ top: parseInt(e.css("top")) - a.height() }),
            e.addClass("placeholder_animate"),
            setTimeout(function () {
              l(e),
                setTimeout(function () {
                  200 == a.outerHeight() && a.addClass("overflow");
                }, 200),
                e.addClass("placeholder_animate2"),
                e.addClass("animate"),
                e.addClass("animate2"),
  ...
  function n(e) {
    t(".awselect_bg").remove(),
      t("body, html").addClass("immersive_awselect"),
      t("body").prepend('<div class = "awselect_bg"></div>'),
      setTimeout(function () {
    ...
    e.attr("data-o-width", a),
      e.attr("data-o-left", s),
      e.attr("data-o-top", o),
      e.addClass("transition_paused").css({ width: a, "z-index": "9999" }),
      setTimeout(function () {
        t(
          ...
          e.css({ position: "fixed", top: o, left: s }),
          e.removeClass("transition_paused"),
          setTimeout(function () {
            t(window).width() < mobile_width
              ? e.css("width", t(window).outerWidth() - 40)
              : e.css("width", t(window).outerWidth() / 2),
              e.css({
  ...
  function s(e) {
    ...
    t(a).each(function () {
      ...
      e.hasClass("animate") &&
        ...
        e.removeClass("animate2"),
        e.find(".back_face").hide(),
        e.find(".back_face").removeClass("overflow"),
        e.removeClass("animate"),
        l(e),
        e.children(".bg").css({ height: 0 }),
        e.removeClass("placeholder_animate2"),
        setTimeout(function () {
  ...
  function o(e) {
    e.siblings(".awselect_placebo").length > 0 &&
      setTimeout(function () {
        ...
        e.css({
          ...
          t(".awselect_bg").removeClass("animate"),
          setTimeout(function () {
            t(".awselect_placebo").remove(),
              t("body, html").removeClass("immersive_awselect"),
              setTimeout(function () {
  ...
  function l(t) {
    ...
    t.find(".front_face .content").attr("data-inactive-color", a),
      t.find(".front_face .content").css("color", e),
      t.find(".front_face .icon svg").css("fill", e);
  }
  function c(a) {
    var i = t(a).val(),
      n = e(t(a)),
    ...
    t(n).find(".current_value").remove(),
      t(n)
        .find(".front_face .content")
        .prepend('<span class = "current_value">' + o.text() + "</span>"),
      t(n).addClass("hasValue"),
      "undefined" != typeof l && l !== !1 && window[l](o.val()),
      setTimeout(function () {
        s();
      }, 100);
  }
  ...
  $(document).ready(function () {
    $("body").on("click", ".awselect .front_face", function () {
      ...
      0 == t.hasClass("animate")
        ? $("select#" + t.attr("id").replace("awselect_", "")).trigger(
            "aw:animate"
          )
        : $("select#" + t.attr("id").replace("awselect_", "")).trigger(
            "aw:deanimate"
